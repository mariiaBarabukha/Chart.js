...
! function(t, e) {
    ...
    function i(t, e) {
        ...
        return function() {
            if(e){
                return clearTimeout(i), i = setTimeout(t, e);
            }
            return t(), e
        }
    }
    ...
    class Li {
        ...
        buildOrUpdateElements(t) {
            const e = this,
                ...
                n = e.getDataset();
            let o = !1;
            e._dataCheck(), i._stacked = Si(i.vScale, i),
             i.stack !== n.stack && (o = !0, Ai(i), i.stack = n.stack), e._resyncElements(t), o && Ci(e, i._parsed)
        }
        configure() {
            const t = this,
                e = t.chart.config,
    ...
    var An = new class {
        ...
        _each(t, e, i) {
            ...
            [...e].forEach((e => {
                ...
                if(i || o.isForType(e) || o === n.plugins && e.id){
                    n._exec(t, o, e)
                }else{
                    J(e, (e => {
                        const o = i || n._getRegistryForType(e);
    ...
    class Jn {
        constructor(t, e) {
            ...
            this.id = j();
            this.ctx = l;
            this.canvas = c, this.width = d, this.height = h,
            this._options = r, this._aspectRatio = this.aspectRatio, 
            this._layers = [], this._metasets = [], this._stacks = void 0, 
            this.boxes = [], this.currentDevicePixelRatio = void 0, 
            this.chartArea = void 0, this._active = [], this._lastEvent = void 0, 
            this._listeners = {}, this._sortedMetasets = [], this.scales = {},
        ...
        _resize(t, e) {
            ...
            if(i.width === a.width && i.height === a.height && r === l) return;
            i.width = a.width, i.height = a.height, i._aspectRatio = i.aspectRatio, ye(i, l, !0), i.notifyPlugins("resize", {
                size: a
            });
            Q(n.onResize, [i, a], i);
            if(i.attached){
                console.log(i._doResize());
                if(i._doResize()){
                    i.render()
                }
            }             
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a 
                    ...
                    s.type = a, 
                    s.indexAxis = o.indexAxis 
                    || En(a, t.options), 
                    s.order = o.order || 0,
                    t._updateMetasetIndex(s, n), 
                    s.label = "" + o.label, 
                    s.visible = t.isDatasetVisible(n), 
                    s.controller) s.controller.updateIndex(n), 
